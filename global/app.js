const getSharedHeaderActivePath = () => {
    ...
    if (path === '/Car-Dealer-Website/mua-xe' || path.startsWith('/Car-Dealer-Website/cars/')) {
        return '/Car-Dealer-Website/mua-xe';
    }

    if (path === '/Car-Dealer-Website/dang-tin-mua-o-to') {
        return '/Car-Dealer-Website/tin-mua-o-to';
    }

    if (path.startsWith('/Car-Dealer-Website/blog/')) {
        return '/Car-Dealer-Website/blog';
    }
...
const renderSharedSiteHeader = () => {
    ...
    const navItems = [
        ...
        { href: '/Car-Dealer-Website/mua-xe', label: 'Tìm mua ô tô', activePath: '/Car-Dealer-Website/mua-xe' },
        { href: '/Car-Dealer-Website/dang-tin-ban-xe', label: 'Đăng bán xe', activePath: '/Car-Dealer-Website/dang-tin-ban-xe' },
        { href: '/Car-Dealer-Website/tin-mua-o-to', label: 'Tin mua ô tô', activePath: '/Car-Dealer-Website/tin-mua-o-to' },
        { href: '/Car-Dealer-Website/khuyen-mai', label: 'Khuyến mại', activePath: '/Car-Dealer-Website/khuyen-mai' },
        { href: '/Car-Dealer-Website/tu-van-ban-hang', label: 'Đội ngũ tư vấn bán hàng', activePath: '/Car-Dealer-Website/tu-van-ban-hang' },
        { href: '/#faq', label: 'Faq' },
        { href: '/Car-Dealer-Website/blog', label: 'Tin tức về xe', activePath: '/Car-Dealer-Website/blog' },
        ...
        mount.innerHTML = `
            <header class="okxe-site-header">
                <nav class="okxe-site-header__nav" aria-label="Điều hướng chính" data-responsive-nav>
                    <a href="/Car-Dealer-Website/" class="okxe-site-header__logo" aria-label="Về trang chủ OkXe">Ok<span>Xe</span></a>
                            ...
                            <div class="okxe-site-header__logged-in" data-site-header-user hidden>
                                <div class="okxe-site-header__account" data-site-account-menu>
                                    ...
                                    <div class="okxe-site-header__dropdown">
                                        ...
                                        <a href="/Car-Dealer-Website/dang-tin-mua-o-to" class="okxe-site-header__dropdown-link"><i class="bx bx-message-square-edit" aria-hidden="true"></i><span>Đăng tin mua ô tô</span></a>
                                        <a href="/Car-Dealer-Website/dang-tin-ban-xe" class="okxe-site-header__dropdown-link"><i class="bx bx-car" aria-hidden="true"></i><span>Đăng bán xe cũ</span></a>
                                    </div>
                                </div>
            ...
            <footer class="okxe-site-footer" id="footer">
                ...
                <div class="okxe-site-footer__container okxe-site-footer__grid">
                    <section class="okxe-site-footer__brand" aria-label="Giới thiệu OkXe">
                        <a href="/Car-Dealer-Website/#home" class="okxe-site-footer__logo">Ok<span>Xe</span></a>
                    ...
                    <nav class="okxe-site-footer__links" aria-label="Liên kết nhanh">
                        ...
                        <a href="/Car-Dealer-Website/#home">Trang chủ</a>
                        <a href="/Car-Dealer-Website/mua-xe">Tìm mua ô tô</a>
                        <a href="/Car-Dealer-Website/tin-mua-o-to">Tin mua ô tô</a>
                        <a href="/Car-Dealer-Website/khuyen-mai">Khuyến mại</a>
                        <a href="/Car-Dealer-Website/blog">Blog ô tô</a>
                        <a href="/Car-Dealer-Website/#faq">Hỏi đáp</a>
                    </nav>

                    <nav class="okxe-site-footer__links" aria-label="Dịch vụ hỗ trợ">
                        <h2>Dịch vụ hỗ trợ</h2>
                        <a href="/Car-Dealer-Website/dang-ky-lai-thu">Đăng ký lái thử</a>
                        <a href="/Car-Dealer-Website/dang-tin-ban-xe">Đăng bán xe cũ</a>
                        <a href="/Car-Dealer-Website/dang-tin-mua-o-to">Đăng tin mua ô tô</a>
                        <a href="/Car-Dealer-Website/tu-van-ban-hang">Tư vấn bán hàng</a>
                        <a href="/Car-Dealer-Website/#rentals">Xe đang bán</a>
                    </nav>
