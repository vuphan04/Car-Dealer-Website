...
const userNotificationLabels = {
    pending: {
        ...
        actionUrl: '/Car-Dealer-Website/dang-tin-ban-xe'
    },
    approved: {
        meta: 'Đăng bán xe',
        icon: 'bxs-check-circle',
        actionText: 'Xem kho xe',
        actionUrl: '/Car-Dealer-Website/mua-xe'
    },
    rejected: {
        meta: 'Đăng bán xe',
        icon: 'bxs-x-circle',
    ...
    notificationsList.innerHTML = notifications.map(({ type, item }) => {
        if (type === 'test-drive') {
            ...
            const appointmentAction = notificationState === 'pending'
                ? `
                            <a href="/Car-Dealer-Website/dang-ky-lai-thu?carId=${encodeURIComponent(String(appointment.carId || ''))}" class="notification-item__action" data-close-notifications-link>
                                <span>Đổi lịch</span>
                ...
                <article class="notification-item">
                    ...
                    <div class="notification-item__body">
                        ...
                        <div class="notification-item__footer">
                            ...
                            <a href="/Car-Dealer-Website/tin-mua-o-to" data-close-notifications-link>
...
const getTeamMemberImage = (member) =>
    String(member?.avatarUrl || '').trim() || '/Car-Dealer-Website/images/showroom-sales-consultant.png';
...
const renderHomeBlog = () => {
    ...
    const cards = posts.map((post) => `
        <article class="home-blog-card">
            <a href="/Car-Dealer-Website/blog/${encodeURIComponent(post.slug)}" class="home-blog-card__media" aria-label="Đọc bài ${escapeHtml(post.title)}">
            ...
            <div class="home-blog-card__body">
                ...
                <a href="/Car-Dealer-Website/blog/${encodeURIComponent(post.slug)}" class="home-blog-card__read">
